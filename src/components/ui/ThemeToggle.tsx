...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    ...
    >
      {isDark ? (
        /* Sol amarelo — clica para ir ao light */
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="18" height="18" fill="#fbff0a">
        ...
        /* Lua preta — clica para ir ao dark */
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="18" height="18" fill="#000000">
